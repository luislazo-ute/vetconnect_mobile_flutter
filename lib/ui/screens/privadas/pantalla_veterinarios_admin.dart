...
/// Gestión (CRUD) de veterinarios — solo ADMIN.
...
class _State extends ConsumerState<PantallaVeterinariosAdmin> {
  ...
  Future<void> _confirmarEliminar(Veterinario v) async {
    ...
    try {
      ...
      messenger.showSnackBar(const SnackBar(content: Text('Veterinario eliminado')));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: estado.cargando && estado.veterinarios.isEmpty
