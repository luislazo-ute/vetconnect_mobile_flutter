...
final iniciarSesionUcProvider = Provider(
  (ref) => IniciarSesionUc(ref.watch(authRepositoryProvider)),
);
final cerrarSesionUcProvider = Provider(
  (ref) => CerrarSesionUc(ref.watch(authRepositoryProvider)),
);
final refrescarTokenUcProvider = Provider(
  (ref) => RefrescarTokenUc(ref.watch(authRepositoryProvider)),
);
final obtenerPerfilUcProvider = Provider(
  (ref) => ObtenerPerfilUc(ref.watch(authRepositoryProvider)),
);
